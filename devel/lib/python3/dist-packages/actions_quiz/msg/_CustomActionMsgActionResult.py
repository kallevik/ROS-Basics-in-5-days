...
"""autogenerated by genpy from actions_quiz/CustomActionMsgActionResult.msg. Do not edit."""
import codecs
import sys
...
class CustomActionMsgActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "actions_quiz/CustomActionMsgActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actions_quiz/CustomActionMsgResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CustomActionMsgActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = actions_quiz.msg.CustomActionMsgResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = actions_quiz.msg.CustomActionMsgResult()
