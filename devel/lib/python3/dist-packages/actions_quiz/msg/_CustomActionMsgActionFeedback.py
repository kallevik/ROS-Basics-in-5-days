...
"""autogenerated by genpy from actions_quiz/CustomActionMsgActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class CustomActionMsgActionFeedback(genpy.Message):
  _md5sum = "99eff65d7d7ea548572edff08e1d4324"
  _type = "actions_quiz/CustomActionMsgActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actions_quiz/CustomActionMsgFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CustomActionMsgActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = actions_quiz.msg.CustomActionMsgFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = actions_quiz.msg.CustomActionMsgFeedback()
