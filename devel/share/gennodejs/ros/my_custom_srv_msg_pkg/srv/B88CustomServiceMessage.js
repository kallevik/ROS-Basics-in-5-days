...
class B88CustomServiceMessageRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type B88CustomServiceMessageRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type B88CustomServiceMessageRequest
    let len;
    let data = new B88CustomServiceMessageRequest(null);
  ...
  static datatype() {
    ...
    return 'my_custom_srv_msg_pkg/B88CustomServiceMessageRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new B88CustomServiceMessageRequest(null);
...
class B88CustomServiceMessageResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type B88CustomServiceMessageResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type B88CustomServiceMessageResponse
    let len;
    let data = new B88CustomServiceMessageResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'my_custom_srv_msg_pkg/B88CustomServiceMessageResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new B88CustomServiceMessageResponse(null);
...
module.exports = {
  Request: B88CustomServiceMessageRequest,
  Response: B88CustomServiceMessageResponse,
  md5sum() { return 'b78c0d1a37ffcec6adef7714dda05daa'; },
  datatype() { return 'my_custom_srv_msg_pkg/B88CustomServiceMessage'; }
};
