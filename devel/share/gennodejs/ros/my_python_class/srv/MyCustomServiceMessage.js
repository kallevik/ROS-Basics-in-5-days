...
// (in-package my_python_class.srv)
...
class MyCustomServiceMessageRequest {
  ...
  static datatype() {
    ...
    return 'my_python_class/MyCustomServiceMessageRequest';
  }
...
class MyCustomServiceMessageResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'my_python_class/MyCustomServiceMessageResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'my_python_class/MyCustomServiceMessage'; }
};
